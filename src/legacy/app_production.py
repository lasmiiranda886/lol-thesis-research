# app_production.py - Optimierte Version für maximale Datensammlung
import os
import time
import random
import threading
...
MASTER_SAMPLE_FRAC = 0.50  # 50% der High-Elo Spieler

TARGET_SUMMONERS_PER_BUCKET = 100  # Maximum pro Rang/Division
MAX_MATCH_IDS_PER_PUUID = 100  # Maximum Matches pro Spieler
MIN_YEAR = 2024  # Nur aktuelle Season
SAVE_DIR = "./data_lol_production"
os.makedirs(SAVE_DIR, exist_ok=True)

MAX_WORKERS = 4  # Reduziert für Stabilität
REQUEST_TIMEOUT = 30
REQS_PER_SEC = 10  # Konservativ für Development Key

_bucket = {"tokens": REQS_PER_SEC, "last": time.time()}
_lock = threading.Lock()

RUN_DEBUG_PROBE = False  # Aus für Produktion
USE_BOOTSTRAP = False
BOOTSTRAP_SUMMONER_NAME = "Faker"

print(f"""
========================================
PRODUKTIONS-KONFIGURATION AKTIV
========================================
Tiers: {', '.join(TIERS)}
Master/GM/Challenger: {INCLUDE_MASTER}/{INCLUDE_GRANDMASTER}/{INCLUDE_CHALLENGER}
Spieler pro Bucket: {TARGET_SUMMONERS_PER_BUCKET}
Matches pro Spieler: {MAX_MATCH_IDS_PER_PUUID}
Speicherort: {SAVE_DIR}
========================================
""")
